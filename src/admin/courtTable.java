 ...
 */
public class courtTable extends javax.swing.JFrame {
 ...
 public void displayData(){
    ...
    private void initComponents() {
        ...
        jPanel1.add(add, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 180, 220, 50));
        ...
        jPanel1.add(back, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 240, 220, 50));
...
if (rowIndex < 0) {
    JOptionPane.showMessageDialog(null, "Please Select An Item!");
      ...
      TableModel model = courtTable.getModel();
    addreservation sf = new addreservation();
    sf.cid.setText(""+model.getValueAt(rowIndex, 0));
    sf.cname.setText(""+model.getValueAt(rowIndex, 1));
    sf.setVisible(true);
    this.dispose();
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(courtTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new courtTable().setVisible(true);
            }
        });
    }
